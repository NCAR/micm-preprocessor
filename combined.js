...
function getPreprocessedCodeHeader( tag_info ) {
  return
`! This code was generated by Preprocessor revision `+revision+`
...
`  !> Calculate the rate constant for each reaction
  subroutine calculate_rate_constants( rate_constants, environmental_state )
...
`;
    for(let i=0; i< this.mapping.length; i++){
      ...
      rate_constant_string += "    rate_constants(" + k_index + ") = " + this.mapping[i].reaction_class + "\n\n";
