...
! This code was generated by Preprocessor revision f96a7bcab3a30adf9d76cf19a3182e110ddbde2e
...
subroutine k_rate_constant(k_rate_constants, number_density_air, temperature, pressure, sad, aerosol_diameter, h2ovmr, o2vmr)
    ...
    Arrhenius_parameters%A = true
    Arrhenius_parameters%C = true
    Arrhenius_parameters%D = true
    Arrhenius_parameters%B = true
    Arrhenius_parameters%E = true
    ...
    Troe_low_pressure_parameters%A_k0 = true
    Troe_low_pressure_parameters%B_k0 = true
    Troe_low_pressure_parameters%C_k0 = true
